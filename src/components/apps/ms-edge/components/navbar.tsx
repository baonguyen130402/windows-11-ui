...
export function Navbar() {
  return (
    <nav className="grid grid-cols-12 w-full h-12 gap-2 px-2 py-2">
      ...
      <div className="col-span-7 border border-gray-500 flex items-center px-2 bg-neutral-900 rounded-full">
