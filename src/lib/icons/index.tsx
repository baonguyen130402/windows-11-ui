  ...
  firefox: (props: IconProps) => (
    ...
    >
      <radialGradient
        ...
        cy="128.524"
        r="170.787"
        gradientTransform="matrix(1 0 0 -.3873 1045.93 354.677)"
      ...
      <ellipse cx="175.9" cy="304.9" rx="175.2" ry="67.9" fill="url(#a)" />
      <linearGradient
        id="b"
        gradientUnits="userSpaceOnUse"
        x1="-977.615"
      ...
      <path
        d="M46.8 52.2c-.4-.6-.4 1.5-.8.8-2.7-4.8-4.9-13-5.2-18.8 0 0-4.4 2.5-7.2 11.5-.5 1.6-.9 2.5-1.2 3.4-.1.3.2-2.9.101-2.6C32 47.6 30.4 49.4 29.9 51.4c-.399 1.6-1 2.5-1.3 4.5-.1.6-.1-2.4-.2-1.9-3.7 9.8-6.7 23.6-5 42.3C40.1 81.3 63.8 70 63.8 70c-2.7-1.7-11.101-8.3-17-17.8z"
        fill="url(#b)"
      />
      <linearGradient
        id="c"
        ...
        x2="-82.561"
        y2="516.124"
        gradientTransform="rotate(14.693 900.084 675.154)"
      >
        <stop offset=".056" stop-color="#dc7327" />
        <stop offset="1" stop-color="#eebc89" />
      </linearGradient>
      <path
        d="M3 203.5c.199-2.799 7-59.399 33.199-78.5 22.601-16.5 5-10.5-3.699-9.8-9.2.7-14.101 6.3-12.301 4.3.101-.1.101-.1.101-.2-.3-.4-21.601 17.5-17.3 84.2z"
        fill="url(#c)"
      />
      <linearGradient
        id="d"
        ...
        x2="-1066.398"
        y2="1592.468"
        gradientTransform="matrix(.9897 -.0801 .0949 1.1727 895.375 -1738.839)"
      >
        <stop offset=".056" stop-color="#dc7327" />
        <stop offset="1" stop-color="#edbd6b" />
      </linearGradient>
      <path
        d="M0 159.3s15.399-49 46.6-48.5c20.7.3 4.3-17.5-2-20.2-6.5-2.8-8.1-2.7-9.6-1.3-2.301 2-22.801 1.2-35 70z"
        fill="url(#d)"
      />
      <radialGradient
        id="e"
      ...
      >
        ...
        <stop offset=".469" stop-color="#f8c91e" />
        <stop offset=".643" stop-color="#eda524" />
        <stop offset=".847" stop-color="#e37b28" />
        <stop offset="1" stop-color="#dd5a26" />
      </radialGradient>
      <path
        d="M285.699 35.9s14.7 7.1 24.2 22.3c7.8 12.4 4.101 29.1-2.899 26.2-6.9-2.9-21.301-48.5-21.301-48.5z"
        fill="url(#e)"
      />
      <radialGradient
        id="f"
      ...
      <path
        d="M311 86c4.1-31.5-25.4-50.2-25.4-50.2s1.9 10.8 4.2 34.8c2.8 27.5 19.3 30.2 21.2 15.4z"
        fill="url(#f)"
      />
      <radialGradient
        id="g"
      ...
      <path
        d="M212.199 329.099C265.5 340.4 305.8 295.4 277 284.6c-26.1-9.8-90.1 39.101-64.801 44.499z"
        fill="url(#g)"
      />
      <radialGradient
        id="h"
      ...
      <path
        d="M281.699 286c53.2-11.6 71.4-69.199 40.801-67.199-27.801 1.799-66 72.699-40.801 67.199z"
        fill="url(#h)"
      />
      <radialGradient
        id="i"
      ...
      <path
        d="M328.9 196.4c34.9-25.2 18.3-70 18.3-70s-7.699 23.1-14.699 50.3C325.6 203.8 308 211.5 328.9 196.4z"
        fill="url(#i)"
      />
      <radialGradient
        id="j"
      ...
      <path
        d="M339.3 118.1c-3.7-43.2-30.5-65.6-30.5-65.6s2.7 14.7 6.3 34.8c4.8 27.5 26.4 56.5 24.2 30.8z"
        fill="url(#j)"
      />
      <radialGradient
        id="k"
        ...
        cy="1462.015"
        r="328.826"
        gradientTransform="matrix(.9408 0 0 .8863 968.075 -1273.786)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        d="M175.6 338.3c93.2 0 168.7-75.6 168.7-168.8C344.3 76.3 268.8.7 175.6.7S6.9 76.3 6.9 169.5c0 93.201 75.5 168.8 168.7 168.8z"
        fill="url(#k)"
      />
      <radialGradient
        id="l"
      ...
      <path
        d="M177.6 205.1c-1 1 .1 3.899 1.4 3.8 1.3-.1 3.199-.699 3.199-.699s1 1.899 0 2.5c-1 .5-3.8.299-.1 1.699 3.8 1.4 4.8 1 5 .301.3-.701 1.5-3.101 2.2-2.9.6-1.2-2-2.4-.601-3.2 1.4-.8.301-3.899.301-3.899s-2 .1-2.801 1.5c-.8 1.399-2-.101-2.8-.101-.1.8-.7 1.5-.7 1.5l-.6-1.3c.101-.1-3.798-.201-4.498.799z"
        fill="url(#n)"
      />
      <defs>
        <path
          id="o"
          d="M175.5 337.9c93.1 0 168.6-75.5 168.6-168.7C344.1 76 268.6.5 175.5.5S6.9 76.1 6.9 169.2c0 93.2 75.5 168.7 168.6 168.7z"
        />
      </defs>
      <clipPath id="p">
      ...
      <radialGradient
        ...
        cy="1634.356"
        r="210.284"
        gradientTransform="matrix(.9408 0 0 .9578 968.075 -1363.087)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".795" stop-color="#00a9d4" stop-opacity="0" />
        <stop offset=".906" stop-color="#50b6e7" stop-opacity=".449" />
        <stop offset=".981" stop-color="#70caf2" />
      </radialGradient>
      <path
        d="M175.5 337.9c93 0 168.3-75.4 168.3-168.4S268.5 1 175.5 1 7.199 76.5 7.199 169.5 82.5 337.9 175.5 337.9z"
        clip-path="url(#p)"
        fill="url(#q)"
      />
      <defs>
      ...
      <radialGradient
        ...
        cy="1490.888"
        r="191.42"
        gradientTransform="matrix(1 0 0 .9811 1023.395 -1405.724)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      />
      <path
        d="M176.199 1.8C241.5 1.8 298.1 39 326 93.4 298.4 38.2 241.4.3 175.5.3 82.5.3 7.199 75.7 7.199 168.7c0 27.7 6.7 53.799 18.5 76.799C14.3 222.8 8 197.201 8 170.2 7.9 77.2 83.3 1.8 176.199 1.8z"
        fill="#8ed8f8"
      />
      <radialGradient
        id="u"
        ...
        cy="1500.043"
        r="322.224"
        gradientTransform="matrix(1 0 0 .9811 1023.395 -1405.717)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <radialGradient
        ...
        cy="1551.643"
        r="239.544"
        gradientTransform="matrix(1 0 0 .9759 1023.395 -1398.236)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".656" stop-color="#b02228" stop-opacity="0" />
        <stop offset=".872" stop-color="#b02127" stop-opacity=".658" />
        <stop offset=".973" stop-color="#b21f24" stop-opacity=".967" />
      ...
      <radialGradient
        ...
        cy="1789.428"
        r="244.548"
        gradientTransform="matrix(.5289 -.8327 .8392 .5131 -743.143 -1563.879)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".71" stop-color="#ed6624" stop-opacity="0" />
        <stop offset=".835" stop-color="#ed6824" stop-opacity=".489" />
        <stop offset=".88" stop-color="#ee6d24" stop-opacity=".665" />
        <stop offset=".912" stop-color="#ef7624" stop-opacity=".791" />
        <stop offset=".938" stop-color="#f28223" stop-opacity=".893" />
        <stop offset=".96" stop-color="#f59123" stop-opacity=".979" />
      ...
      <radialGradient
        ...
        cy="1696.788"
        r="78.672"
        gradientTransform="matrix(1 0 0 .6267 1023.395 -969.954)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#e05a27" stop-opacity=".1" />
        <stop offset=".306" stop-color="#de5926" stop-opacity=".845" />
        <stop offset=".556" stop-color="#b02228" />
      </radialGradient>
      <path
        d="M171 100.4c-.2-3.3-2.301-5.6-29.4-5.4-11.1.1-16.3-9.6-18.1-13.7-2.9 10.5-3.4 21.3-1.2 34 1.399 8.4 7.399 15.5 10.7 20.5.8.8 1.199 1 1.399.5 1.2-2.6 25-16.1 26.9-17.6 2.001-1.3 10.201-8.3 9.701-18.3z"
        fill="url(#x)"
      />
      <radialGradient
        id="y"
        ...
        cy="2082.353"
        r="66.229"
        gradientTransform="matrix(.9539 -.2859 .1382 .4185 798.093 -1056.18)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#e05a27" stop-opacity="0" />
        <stop offset=".446" stop-color="#dd5a26" stop-opacity=".8" />
        <stop offset=".722" stop-color="#b02228" />
      </radialGradient>
      <path
        d="M133.9 97.3s9.4 4.6 10.8 7.5c.4.9-4.8-1.6-4.5-.6.301 1 6.801 4.3 7 5.9.2 1.2-3.6-1.3-5.6-1.6 1.2 1 2.8 2.5 1.9 3.5-.9 1-4.2 1.4-4.801 1.8-8.6 5.5 12.2 6.8 19.7 2.7 7.5-4 12.2-9.9 12.4-10.8.3-.9 2.7-8.8-13-6.1-9.899 1.8-16.1 1.6-23.899-2.3z"
        fill="url(#y)"
      />
      <radialGradient
        id="z"
      ...
      <path
        d="M262 303.099c-9.101 5-30.601 11.602-36.7 11.9 37.5-11.6 49.6-27.299 55.8-37.699 19.4-3.801 54.8-21.4 56.2-41.9-1.5 28-24.601 47.4-41.2 58.6-19.6 13.301-36.2 14.4-50.3 23.4 4.3-3 9.899-6.9 16.2-14.301z"
        fill="url(#z)"
      />
      <radialGradient
        id="A"
      ...
      <path
        d="M347.199 126.4c11.7 38.1-7.5 54.6-15.6 59.7 10.3-28.4 14-63.7 2.8-94.7C325.1 65.5 309 52.6 309 52.6c22.6 24.7 20 52 13.399 71.2 3.101 18.1-7.3 68.401 5.7 66.1-3.1 28.1-15.2 62.6-20.6 73.1 9-14.199 21.899-27.399 27.8-38.5 11.201-21.1 24.301-62.6 11.9-98.1z"
        fill="url(#A)"
      />
      <radialGradient
        id="B"
      ...
      <path
        d="M301.3 135.3s-5 9.7-4.601 28.6c-6.399-24.7-19.3-34.6-19.3-34.6 1.7 19.9 5.2 48.8-2.5 73.5.9 7.199 2.7 24.9-4.2 44 11.301-13 26.301-23.5 28.5-34 0-.301.101-.7.101-1 3.8.699 9.1-2.2 13.7-6.801 3.8-6.5 13.8-25.899 14.699-36.299C304 159.2 301.3 135.3 301.3 135.3z"
        fill="url(#B)"
      />
      <radialGradient
        id="C"
      ...
      <path
        d="M297.1 200.1c30.8-43.1 20.1-88 16.8-101.8 44.2 72.5-1.1 156.7-10.3 170.8-2.5 2-16.7 7.3-22.5 7.899 1.9-2.899 6.8-13 6.2-24.899-6.7 16.399-30.5 28.601-43.7 33.101 22.8-16.5 49-62.5 53.5-85.101z"
        fill="url(#C)"
      />
      <radialGradient
        id="D"
      ...
      <path
        d="M291.9 167.7s2.5 37.5-16.399 67.5c5.1-28.301-4.801-46.101-4.801-46.101s-1.399 15.3-7.399 30.101c-10.4 25.5-19.8 30.699-23.5 28-8 31.699-60.9 30.199-60.9 30.199 12 3 54.101 5.301 85-17.4-1.7 4-11.199 23.101-34 32.9 22.5-1.4 52.2-25.199 57.5-40.9.4 11.801-3.399 20-5.899 24.701 37.498-41.999 10.398-109 10.398-109z"
        fill="url(#D)"
      />
      <linearGradient
        id="E"
        ...
        x2="-817.398"
        y2="1734.201"
        gradientTransform="rotate(-1.812 -45402.04 -31747.46)"
      >
        ...
        <stop offset=".82" stop-color="#de5b26" stop-opacity=".059" />
      </linearGradient>
      <path
        d="M172.6 298.201c19.6-1.801 35.6-6.201 46.4-20.4-17.7 3-31.7 1.699-40.4-.301 0 0 13.9.601 31.5-3.899 20.4-5.101 45.7-17 60.2-44.3-.7 64.999-66.601 77.9-97.7 68.9z"
        fill="url(#E)"
      />
      <linearGradient
        id="F"
      ...
      >
        ...
        <stop offset=".406" stop-color="#bf3628" stop-opacity=".744" />
        <stop offset=".623" stop-color="#c84228" stop-opacity=".51" />
        <stop offset="1" stop-color="#e05a27" stop-opacity="0" />
      </linearGradient>
      <path
        d="M46.699 52.2c-.399-.6-.399 1.4-.799.8-2.7-4.8-4.899-13-5.2-18.8 0 0-4.399 2.5-7.199 11.5-.5 1.6-.9 2.5-1.2 3.4-.101.3.2-2.9.1-2.6-.5 1.1-2.1 2.9-2.6 4.9-.4 1.6-1 2.5-1.3 4.5-.101.6-.101-2.4-.201-1.9-7 17.6-6.2 43.3-5.3 42.2 16.6-21.6 37.5-28.5 37.5-28.5-2.5-1.7-7.9-6-13.801-15.5z"
        fill="url(#F)"
      />
      <linearGradient
        id="G"
      ...
      <linearGradient
        ...
        gradientTransform="translate(1023.395 -1428.383)"
      >
        <stop offset=".043" stop-color="#dd5a26" />
        <stop offset=".258" stop-color="#eca77c" />
        <stop offset="1" stop-color="#f9f7c9" />
      </linearGradient>
      <path
        d="M169.199 107.6c-.199 0-.399-3.2-.1-2.4.2.7-.3 7.2-6.2 11-1.3.8-.1-2.1-1.5-.6-2.3 2.5-8 10.8-22.3 10.8-.5 0 5.6-2.7 4.9-2.5-1.5.4-3.2.9-8.801 2.7-.5.2 4.7-3.2 4.2-3.1-.7.2-3.8 2.3-7.6 3.9 1.8-1.8 3.899-3.6 3.2-3.3-3 1.7-5.2 3.6-6.5 5.5.899 1.5 2 2.4 2.8 3.9 2 2.4 2.2 4.9 2.7 4.2 5.3-6.4 26.199-16.1 30.899-21.1 4.802-5.2 2.903-4.4 4.302-9z"
        fill="url(#H)"
      />
      <radialGradient
        id="I"
        ...
        cy="1705.251"
        r="95.217"
        gradientTransform="matrix(1 0 0 .8428 1023.395 -1216.665)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".5" stop-color="#e05a27" stop-opacity="0" />
        <stop offset=".75" stop-color="#de5926" stop-opacity=".775" />
        <stop offset=".95" stop-color="#b02228" />
      </radialGradient>
      <path
        d="M138.199 252.4c-26.899-8.4-57.6-20.8-60-56.1C75 150 117.6 155 117.6 155c-1.5.6-4.8 4-5.9 7.9-1.199 4.2-3.399 12.4 6.2 20.9 15.2 13.401-25 38.3 43.5 70.1 1.7.7-15.3 1-23.201-1.5z"
        fill="url(#I)"
      />
      <linearGradient
        id="J"
      ...
      <path
        d="M171.4 108.2c1.2-3 2.601-10-1.399-11.5-3.301-.8-6.2-1.4-11.601-1.3 1.8.4 7 1.5 8.3 3.9 2.601 4.6.5 13.6-.399 15.9 2.699-2.1 3.898-4.1 5.099-7z"
        fill="url(#J)"
      />
      <radialGradient
        id="K"
        ...
        cy="1766.979"
        r="87.31"
        gradientTransform="matrix(.9863 -.1647 .1249 .7478 843.568 -1298.49)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".5" stop-color="#e05a27" stop-opacity="0" />
      ...
      <path
        d="M127.5 229.9c18.8 4.5 40 1.301 52.1-7 8.1-5.6 19.8-13.9 25.1-13-6-1.699-10.6-2.4-15.899-2.1-1 0-1.9.1-2.9.199-1.8.201-3.699.4-5.8.801-3.2.699-6.7 3.1-10 3.1-.2 0 3.101-1.699 2.8-1.699-1.699.5-3.6.799-5.6 1.299-1.2.301-2.4.5-3.601.701-37.699 7-72.199-13.5-72.199-13.5C89.6 208.201 106.4 224.9 127.5 229.9z"
        fill="url(#K)"
      />
      <radialGradient
        id="L"
        ...
        cy="1459.35"
        r="164.471"
        gradientTransform="matrix(.9996 -.0268 .0263 .9807 991.64 -1424.899)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#ffe000" stop-opacity="0" />
        <stop offset=".355" stop-color="#fed700" stop-opacity=".515" />
        <stop offset=".483" stop-color="#fed208" stop-opacity=".7" />
        <stop offset=".857" stop-color="#fed208" stop-opacity="0" />
      </radialGradient>
      <path
        d="M289.199 78.5s14.4 15.5 21.2 30.3c6.8 14.8 8.9 31.6 8.9 31.6s1-14.1-6.8-37.8c-8.4-25.7-25-47.7-41.4-59.8-11-8.3-33.1-19.3-33.1-19.3s38.101 22.6 51.2 55z"
        fill="url(#L)"
      />
      <radialGradient
        id="M"
      ...
      <radialGradient
        ...
        cy="3213.962"
        r="53.88"
        gradientTransform="matrix(-.2756 .9504 .6431 .1776 -2594.436 2149.379)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#fff" />
        <stop offset=".027" stop-color="#fffbe8" stop-opacity=".963" />
        <stop offset=".102" stop-color="#fff2b6" stop-opacity=".857" />
        <stop offset=".174" stop-color="#ffed8c" stop-opacity=".756" />
        <stop offset=".24" stop-color="#ffe967" stop-opacity=".662" />
        <stop offset=".3" stop-color="#ffe645" stop-opacity=".578" />
        <stop offset=".352" stop-color="#ffe42c" stop-opacity=".506" />
        <stop offset=".389" stop-color="#ffe421" stop-opacity=".454" />
        <stop offset=".809" stop-color="#ffe300" stop-opacity="0" />
      </radialGradient>
      <path
        d="M208.4 198.6c-1.8-2.399-9.6-8.101-18.3-8.7-11.6-.8-21 4.2-21 4.2s6.4-3.7 21.2-2.399c10.2.899 18 6.599 18.1 6.899z"
        opacity=".5"
        fill="url(#N)"
      />
      <radialGradient
        ...
        cy="3148.419"
        r="56.149"
        gradientTransform="matrix(-.3166 .8278 .6529 .2379 -2717.338 1725.642)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#fff" />
        <stop offset=".027" stop-color="#fffbe8" stop-opacity=".963" />
      ...
      <path
        d="M212.3 203.201c-1.8-2.5-8.4-8.301-19-10.4-13.5-2.6-23.4 3.1-23.4 3.1s7.7-3.199 23.3-.699c10.7 1.798 18.9 7.798 19.1 7.999z"
        opacity=".5"
        fill="url(#O)"
      />
      <radialGradient
        ...
        cy="3394.988"
        r="42.108"
        gradientTransform="matrix(-.2345 .5201 .5377 .2307 -2304.132 936.503)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#fff" />
        <stop offset=".027" stop-color="#fffbe8" stop-opacity=".963" />
      ...
      <path
        d="M208.5 203.3c-1.5-1.4-4.9-3.801-10.801-5.5-9.5-2.7-15.899-.2-15.899-.2s3.8-.899 13.5 1c6 1.2 13.1 4.601 13.2 4.7z"
        opacity=".5"
        fill="url(#P)"
      />
      <linearGradient
      ...
      <radialGradient
        ...
        cy="5985.437"
        r="111.592"
        gradientTransform="scale(1 -1) rotate(88.401 4045.76 2116.623)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#ed6624" />
        <stop offset="1" stop-color="#f69622" />
      ...
      <radialGradient
        ...
        cy="1467.184"
        r="43.928"
        gradientTransform="matrix(.9569 .2903 .1939 -.6392 698.864 1297.31)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".487" stop-color="#e57c27" stop-opacity="0" />
        <stop offset=".853" stop-color="#f0be1b" />
      </radialGradient>
      <path
        d="M100.9 67s-2.7 3.2-4.7 6.4c-2.3 3.5-4.2 7.2-4.2 7.2s-11.4-8.4-21.6-10.1-13.2-1.4-13.2-1.4 16.999-8.8 43.7-2.1z"
        fill="url(#S)"
      />
    </svg>
  ),
